                ...
                {FootCats.map((e,index)=>{
                    ...
                    <div
                        className="relative w-[340px] overflow-x-hidden md:w-[500px] lg:w-[660px] h-[300px] mt-5 rounded-md">
                            ...
                            <div class="p-6 bg-[#fed1b0] shadow-black shadow-sm border-gray-200 rounded-lg ">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight flex justify-center text-gray-900">{e.title}</h5>
