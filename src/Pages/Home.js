    ...
    return(
        <>
                ...
                <div className="flex items-center  flex-col p-3 lg:flex-row overflow-x-hidden justify-center bg-[#5667]  md:justify-evenly flex-wrap">
                    ...
                    {data.map((e,index)=>{
                        return(
                            <div class=" bg-white border border-gray-200  rounded-lg shadow  flex justify-center items-center flex-col h-[360px] w-[360px] md:w-[470px] md:h-[460px] lg:w-[550px] lg:h-[560px] mt-5 transition-all">
                                    <img class="rounded-t-lg w-full h-full" src={e.img} alt="" />
                                <div class="p-2  flex justify-center items-center flex-col text-xl">
                                        <h5 class="mb-2 text-3xl md:text-5xl lg:mb-5 font-bold tracking-tight text-gray-900">{e.title1}</h5>
                                        <h5 class="mb-2 text-3xl md:text-5xl lg:mb-5 font-bold tracking-tight text-gray-900">{e.title2}</h5>
